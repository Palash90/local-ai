                ...
                "properties": {
                    "score": {
                        ...
                        "description": (
                            ...
                            "chorus/bridge/outro. LOOP SEMANTICS: if a lane's "
                            ...
                            "(2-4 bars: verse, distinct chorus, bridge) and "
                            ...
                            "~16-28 bars (~30-75s).\n\n"
                            "EXAMPLE (jazz fusion, verse->chorus, DUET WITH "
                            "LEAD HANDOFF — sax leads verse, epiano leads "
                            "chorus with a lifted answer):\n"
                            "  @tempo 120\n"
                            "  @genre jazz\n"
                            ...
                            "R h A5 e B5 e C6 q | D6! h R q |\n"
                            "  [MELODY2 epiano vol=80]\n"
                            "  R w | R h F5 e A5 e C6 q | C6! q B5 e C6 e D6 h | "
                            "E6! q D6 e C6 e B5 w |\n"
                            ...
                            "notes like 'Dm4 q' (invalid — the parser drops "
                            "the whole bar; write 'D3:min7 q'); prose tokens "
                            ...
                            "for 20 bars (monotony); a 'duet' where MELODY2 "
